                                ...
                                <div className='max-w-lg w-full'>
                                    <form className='bg-white rounded shadow-md px-8 pt-6 pb-8 mb-4' onSubmit={e => verificarPassword(e)}>
                                        ...
                                        <div className='mb-4'>
                                            ...
                                            <input type='password' id='password' className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' placeholder='Password del Enlace'
                                                value={password}
                    ...
                    (
                        <>
                            ...
                            <div className="flex items-center justify-center mt-10">
                                <Link href={`${process.env.backendURL}/api/archivos/${enlace.archivo}`} className="bg-red-500 text-center px-10 py-3 rounded uppercase font-bold text-white cursor-pointer hover:bg-red-800">Aqui</Link>
                            </div>
                        </>
                    )
            }
