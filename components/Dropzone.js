...
// Con useCallback hacemos que solamente se renderize una vez
import React, { useCallback, useContext } from 'react';
import clienteAxios from "../config/axios";
import appContext from "../context/app/appContext";
import authContext from "../context/auth/authContext";
import SegundoSpinner from "./SegundoSpinner";
        ...
        <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0 flex flex-col items-center justify-center border-dashed border-gray-400 border-2 bg-gray-100 px-4">
            {acceptedFiles.length > 0 ? (
                <div className="mt-10 w-full">
                    ...
                    {cargando ? <SegundoSpinner /> : (
                        <button type="button"
                            className="bg-blue-700 w-full py-3 rounded-lg font-bold my-10 hover:bg-blue-800"
                            onClick={() => crearEnlace()}
                        >
                            Crear Enlace
                        </button>
                    ...
                    <input className="h-100" {...getInputProps} />
                    {
                        isDragActive ? <p className="text-2xl text-center text-gray-600">Suelta el archivo</p> :
                            <div className="text-center">
                                ...
                                <button className="bg-blue-700 w-full py-3 rounded-lg font-bold my-10 hover:bg-blue-800" type="button">
