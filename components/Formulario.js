...
const Formulario = () => {
    ...
    const { agregaPassword, agregarDescargas } = AppContext
        ...
        <div className='w-full mt-20'>
            ...
            <div className='mt-4'>
                <div className='flex justify-between items-center'>
                    <label className='text-xl text-gray-800 mr-2'>Protejer con Contraseña</label>
                    <input
                        type='checkbox'
                ...
                {tienePassword ? (
                    <input
                        ...
                        onChange={(e) => agregaPassword(e.target.value)}
                    />
                ) : null}
